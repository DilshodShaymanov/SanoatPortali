...
export class User extends Model<User, ICreationUserAttr> {
  ...
  @ApiProperty({ example: 'Ali12345', description: 'Foydalanuvchi paroli' })
  @Column({ type: DataType.STRING, allowNull: false })
  password: string;

  @ApiProperty({ example: 'Ali12345', description: 'Parolni tasdiqlash' })
  @Column({ type: DataType.STRING, allowNull: false })
  confirm_password: string;
  ...
  @ApiProperty({ example: 'user.jpg', description: 'Foydalanuvchi rasmi' })
  @Column({ type: DataType.STRING, allowNull: true })
  image: string;

  @ApiProperty({ example: '123456789', description: 'STIR (INN) raqami' })
  @Column({ type: DataType.STRING, allowNull: false, unique: true })
  stir: string;
